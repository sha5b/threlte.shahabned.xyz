<script lang='ts'>
	...
	function getRandomGridPosition(range: any, step: any) {
	...
	const categoryPositions: any = new Map(
		categories.map((category: any) => [category.id, getRandomGridPosition(range, step)])
	);
</script>
